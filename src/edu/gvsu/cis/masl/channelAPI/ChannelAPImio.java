...
public class ChannelAPImio {
     ...
     */
    public ChannelAPImio(String URL, String channelKey, ChannelService channelService) throws IOException, ClientProtocolException {
    	this.clientId = null;
    	this.BASE_URL = URL;
    	this.requestId = 0;
    	this.messageId = 1;
    ...
    private String createChannel(String key) throws IOException, ClientProtocolException{
		...
		HttpGet httpGet = new HttpGet(BASE_URL + "/gestor_mensajes?userid=" + key);
		try{
    ...
    public boolean send(String message, String urlPattern) throws IOException {
        ...
        String url = "http://plsfservidor.appspot.com/chat";
        List<NameValuePair> params = new ArrayList<NameValuePair>();
